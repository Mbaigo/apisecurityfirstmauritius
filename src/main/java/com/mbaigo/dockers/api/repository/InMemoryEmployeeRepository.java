...
public class InMemoryEmployeeRepository {
    ...
    static {
        DB.add(new Employee(1L,"ISSA","Joseph","562-393-334","isajo@gmail.com","FR2931"));
        DB.add(new Employee(2L,"Abakar","Mbai","562-678-334","abakar@gmail.com","FR2932"));
        DB.add(new Employee(3L,"Youssouf","Eric","777-393-334","mbai@gmail.com","FR2934"));
        DB.add(new Employee(4L,"Youssouf","Eric","777-394-334","mbai@gmail.com","FR3934"));
...
/*
    ...
    public List<Employee> getByFirstName(String firstName){
         List<Employee> list= DB.stream()
                .filter(emp->firstName.equals(emp.getFirstName())).toList();
         return list;
    }
